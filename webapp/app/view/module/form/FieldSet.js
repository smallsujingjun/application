...
Ext.define('app.view.module.form.FieldSet', {
	...
	initComponent : function() {
		...
		for ( var i in this.schemeGroup.tf_groupFields) {
			...
			var fieldDefine = this.getViewModel().getFieldDefine(
					field.tf_fieldId);
		...
		for ( var i in containers) {
			this.items.push(app.view.module.factory.FieldContainerFactory
					.getContainer(containers[i], this.getViewModel(),
							this.formtype));
		}
		...
		for ( var i in hiddens) {
			var field = hiddens[i];
			var fieldDefine = this.getViewModel().getFieldDefine(field.tf_fieldId);//this.module.getFieldDefine(field.tf_fieldId);
